...
/*Luodaan aineiston sisältävä tiedosto ja luetaan aineisto tiedostosta.*/

luo_aineisto(aineisto, aineisto_koko);
lue_aineisto(&juuri, &etp, &lkm, lkm_taulukko);
...
/*Aineiston sisältävän tiedoston luominen.*/
...
/*Aineiston sisältämien avainten lukeminen tiedostosta ja niiden lisääminen puuhun.*/
...
/*Uuden solmun lisääminen puuhun.*/
...
/*L- ja LR-kiertojen suorittaminen.*/
...
/*R- ja RL-kiertojen suorittaminen.*/
...
/*Alkion lisääminen linkitetyn listan viimeiseksi alkioksi.*/
...
/*Puussa olevien avainten tulostaminen tasoittain.*/
...
/*Tarvittavien tasojen ja varattavan taulukon koon määrittäminen.*/
...
/*Puun läpi käyminen tasoittain jaavain taulukon päivittäminen.*/

while (alku != NULL) {
	alku = lue_taso(alku, avaimet, &n, solmut);
}

/*Itse avainten tulostaminen tasoittain.*/
...
/*Avaimet sisältävän taulukon päivittäminen taso kerrallaan.*/
...
/*Puun tyhjentäminen ja muistin vapauttaminen.*/
